            ...
            operators[i].addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent actionEvent) {
                    if (finalI == 5)
                        ...
                        try {
                            String infixExpression = area.getText();
                            String postfixExpression = FormaPoloneza.CreareFromaPoloneza(infixExpression);
                            double result = FormaPoloneza.Rezultat(postfixExpression);
                            area.append(" = " + result);
                        } catch (Exception e) {
